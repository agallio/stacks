  ...
  prompts: [
    {
      ...
      choices: [
        ...
        {
          name: 'Expo 52 + Next.js 14 (Turborepo with yarn)',
          value: 'next-14-expo-52',
        },
        {
          name: 'Expo 53 + Next.js 15 (Turborepo with yarn)',
          value: 'next-15-expo-53',
        },
        {
          name: 'Expo 54 + Next.js 15 (Turborepo with pnpm)',
          value: 'next-15-expo-54-pnpm',
        },
        {
          name: 'Expo 54 + Next.js 15 App Router (Turborepo with pnpm)',
          value: 'next-15-expo-54-app-pnpm',
        },
      ],
      default: 'next',
    },
